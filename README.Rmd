...
The goal of SapCal is to calculation of sap flow using HFD (Nadezhdina et al. 2012) and LHB methods (Trcala and Cermak 2016). This package is created associated with the study "Inconsistent results of sap flow calculations from Heat Field Deformation (HFD) and Linear Heat Balance (LHB) methods" (Zhao et al., to be published).
